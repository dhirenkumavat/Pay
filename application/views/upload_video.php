                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label>Select Video</label>
                                        <input type="file" class="form-control" name="" id="myfile">
...
<select id="chkveg" multiple="multiple" name="" class="form-control" style="">
    <?php foreach ($outletdata as $outlet):
						...
						<div class="form-example-int mg-t-15">
                            <button type="submit" name="submit"  class="btn btn-success notika-btn-success" id="btn">Add</button>
                        </div>
                    </div>
					</form>
                </div>
            ...
            $(function () {
                $('#btn').click(function () {
                  ...
                  var brand_id = $('#brand_id').val();
                    if (chkveg == '' || myfile == '' || remark==''|| brand_id=='') {

...
<select class="form-control state" id="state" name="state">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
				                     <label>Pincode</label>
                                        ...
                                        <input type="hidden" class="form-control" value="<?php echo $this->uri->segment('3');?>" name="brandid">
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-group">
					  ...
					  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-group">
                          ...
                          <input type="text" class="form-control" name="location" id="address" value="address">
                        </div>
	...
	<p>Longitude: <input size="20" type="text" id="lngbox" name="lng" ></p>
						 ...
						 <div class="form-example-int mg-t-15">
                            <button type="submit" name="submit" id="sucbtn" class="btn btn-success notika-btn-success">Add</button>
                        </div>
                    </div>
					</form>
                </div>
...
$(".state").on("change", function(){
    ...
    $.post("<?=base_url()?>admin/select_city2", {state: state}, 
    function(data){
		   //console.log(data);
